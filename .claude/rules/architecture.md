...
- Build happends in github pages to deploy the static site, but the source code must be directly runnable without any build steps. > .github/workflows/static.yml
...
- Pages are organized and grouped by Bloom's Taxonomy levels inside `5_Symbols/data/menu.json` (stored on Azure storage and loaded dynamically):
  - **Remember**: flashcards, slideshow, mastery, quiz for memory cards, memory cards.
  - **Understand**: Quizes, Mock Exams and Pro Exams
