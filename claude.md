...
- **Markdown File Naming:** All markdown (`.md`) files in the project must use lowercase snake_case (e.g., `deployment_checklist.md`, `pro_exam_status.md`). Never use UPPERCASE filenames for markdown files.
